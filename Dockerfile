...
COPY app.py web_data.py database.py api.py openapi.py charts.py newsroom_web.py metrics.py gunicorn.conf.py betting.py accounts.py chat.py monetization.py ./
